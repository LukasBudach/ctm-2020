...
res <- run_wordfish(tdmat=mat,
                    repr_1=7, # representative for position 1
                    repr_2=9, # representative for position 2
                    name='party_p_17_19_co_100_green18_cdu18',
                    tol=1e-7)
# visualization
party_speeches_by_party(raw=visualization_copy, res=res, filename='data/party_p_17_19_co_100_green18_cdu18.png', TRUE)
draw_eiffel_tower_diagram(res=res, filename='data/party_p_17_19_co_100_green18_cdu18_words.png')
...
res <- run_wordfish(tdmat=mat,
                    ...
                    name='speaker_p_17_19_co_100_Hofreiter_Hollnagel',
                    tol=1e-7)
# visualization
speaker_speeches_by_party(raw=visualization_copy, res=res, filename='data/speaker_p_17_19_co_100_Hofreiter_Hollnagel.png')
draw_eiffel_tower_diagram(res=res, filename='data/speaker_p_17_19_co_100_Hofreiter_Hollnagel_words.png')
...
res <- run_wordfish(tdmat=mat,
                    repr_1=7, # representative for position 1
                    repr_2=9, # representative for position 2
                    name='party_p_17_19_nc_100_green18_cdu18',
                    tol=1e-7)
# visualization
party_speeches_by_party(raw=visualization_copy, res=res, filename='data/party_p_17_19_nc_100_green18_cdu18.png', multiple_periods=TRUE)
draw_eiffel_tower_diagram(res=res, filename='data/party_p_17_19_nc_100_green18_cdu18_words.png')
...
res <- run_wordfish(tdmat=mat,
                    repr_1=7, # representative for position 1
                    repr_2=9, # representative for position 2
                    name='party_p_17_19_co_100_np_green18_cdu18',
                    tol=1e-7)
# visualization
party_speeches_by_party(raw=visualization_copy, res=res, filename='data/party_p_17_19_co_100_np_green18_cdu18.png', TRUE)
draw_eiffel_tower_diagram(res=res, filename='data/party_p_17_19_co_100_np_green18_cdu18_words.png')
